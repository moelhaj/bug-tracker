	...
	return (
		<div className="relative w-full">
			...
			<DropDown
				...
				styles="x-center bg-white dark:bg-gray-900 dark:border-gray-700 px-1 absolute z-20 -top-28 flex flex-col gap-3 w-72 p-3 rounded-md border border-gray-300 h-72"
			>
