...
export default function Block({ data, icon, title, type }: Props) {
	return (
		<div className="flex-1 rounded-md p-3 dark:bg-gray-800">
			...
			{data?.length < 1 && (
				<div className="mt-3 flex flex-col items-center gap-3 rounded-md border border-gray-200 bg-white py-10 text-sm text-gray-400 dark:border-none dark:bg-gray-800">
			...
			<div className="mt-3 flex flex-col gap-3">
				{data?.map((item: any) => (
					<div
						key={item.id}
						className="rounded-md border border-gray-200 bg-white p-3 dark:border-none dark:bg-gray-800"
					>
